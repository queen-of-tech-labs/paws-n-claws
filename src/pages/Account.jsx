          ...
          <Card className="border-blue-500/50 bg-gradient-to-b from-blue-500/10 to-slate-900/50">
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="space-y-3">
                {["Unlimited Pets", "Community Pet Parent Forum", "Detailed Pet Care Guides", "Vet Network", "24/7 AI Pet Assistant", "Symptom Checker", "Digital Pet Health Passport", "Lost Pet Recovery Network"].map((feature) => (
